...
export default class Pulse extends Component {
	...
	render(){
		...
		const {wrapperStyle, contentView} = this.props;
		...
		return (
			<View style={containerStyle}>
				{started &&
				<View style={[pulseWrapperStyle, wrapperStyle]}>
					{pulses.map((pulse) =>
						<View
							key={pulse.pulseKey}
							style={[
