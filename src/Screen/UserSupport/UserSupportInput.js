...
class UserSupportInput extends React.Component {
  form = {
    fields: {
      query: '',
    },
  ...
  onSubmit = (values, _actions) => {
    this.props.supportTicketActions.createSupportTicket({
      ...
      onSuccess: () => {
        this.props.navigation.navigate('UserSupportSent');
      },
      onFail: (error) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(UserSupportInput);
